        ...
        <div className="projects-section-main-content-box">
          ...
          <div className="my-projects">
            <div className="projects-img">
              <img
                className="project-item-img"
                src={require("../Images/react-quiz-final.png")}
              />
            </div>
            <div className="projects-description">
              <div className="project-name">React Quiz</div>
              <div className="project-tagline">
              React Quiz is a user-friendly WebApp that presents a set of four answer choices for each question. By selecting the appropriate option, users can swiftly evaluate their performance and receive a calculated score based on the number of correct answers.
              </div>
              <div className="project-techstack-container">
                <div className="project-techstack-items">REACT JS</div>
              </div>
              <div className="project-item-link">
                <div className="project-links">
                    <a href="https://github.com/sshiwangi/React-Quiz" target='_blank'>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="36"
                    height="36"
                ...
                <div className="project-links">
                <a href="react-quiz-six-steel.vercel.app/" target='_blank'>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="36"
                    height="36"
          ...
          <div className="my-projects">
            ...
            <div className="projects-description">
              <div className="project-name">Meme Generator</div>
              <div className="project-tagline">
              The meme generator is a web-based meme generator that allows users to create their own memes combining text and images in a humorous or satirical way.
              </div>
              <div className="project-techstack-container">
                <div className="project-techstack-items">React JS</div>
              </div>
              <div className="project-item-link">
                <div className="project-links">
                    <a href="https://github.com/sshiwangi/Meme-Generator" target='_blank'>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="36"
                    height="36"
                ...
                <div className="project-links">
                <a href="get-memes-five.vercel.app/" target='_blank'>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="36"
                    height="36"
